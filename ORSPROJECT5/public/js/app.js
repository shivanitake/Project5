...
/**
 * Define angular routes:Function of ngRoute
 */
app.config(function ($routeProvider, $httpProvider) {
  ...
  $routeProvider
    ...
    .when("/getmarksheet", {
      templateUrl: "view/GetMarksheet.html",
      controller: 'getmarksheetCtl'
    })
    .when("/college", {
    ...
    .when("/meritList", {
      templateUrl: "view/MeritList.html",
      controller: 'meritListCtl'
    })
    .when("/course", {
    ...
    .when("/faculty", {
      ...
      controller: 'facultyCtl'
    })
    .when("/timetable", {
      templateUrl: "view/TimeTable.html",
      controller: 'timetableCtl'
    })
    .when("/marksheet", {
 ...
 * restrict A indicate "fileModel" to be used as attribute only on 
 * 
 */
